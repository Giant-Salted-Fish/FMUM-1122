package gsf.fmum.client.render;

import gsf.fmum.util.Animation;
...
public final class CoupledAnimation implements IAnimator
{
	...
	public CoupledAnimation( Animation animation ) {
		this( animation, () -> 1.0F );
	}
	...
	@Override
	public void update() {
		this.animation.update( this.progress.get() );
	}
	
	@Override
	public void getPos( String channel, Vec3f dst ) {
		this.animation.getPos( channel, dst );
	}
	
	@Override
	public void getRot( String channel, Quat4f dst ) {
		this.animation.getRot( channel, dst );
	}
	
	@Override
	public float getFactor( String channel ) {
		return this.animation.getFactor( channel );
	}
