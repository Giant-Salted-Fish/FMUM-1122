...
import gsf.fmum.client.ModConfigClient;
import gsf.fmum.common.ammo.AmmoType;
import gsf.fmum.common.gun.GunPartType;
import gsf.fmum.common.item.IItem;
import gsf.fmum.common.item.IItemType;
import gsf.fmum.common.load.IContentBuildContext;
import gsf.fmum.common.load.IContentLoader;
import gsf.fmum.common.module.IModuleSlot;
import gsf.fmum.common.module.StepRailSlot;
import gsf.fmum.common.network.IPacket;
import gsf.fmum.common.network.PacketHandler;
import gsf.fmum.common.pack.IContentPack;
import gsf.fmum.common.pack.IContentPackFactory;
import gsf.fmum.common.pack.IContentPackFactory.ILoadContext;
...
import gsf.fmum.common.pack.IContentPackFactory.IPrepareContext;
import gsf.fmum.common.pack.LocalPack;
import gsf.fmum.common.paintjob.JsonPaintjob;
import gsf.fmum.common.player.PlayerPatch;
import gsf.fmum.common.tab.ICreativeTab;
import gsf.fmum.common.tab.JsonCreativeTab;
import gsf.fmum.util.AngleAxis4f;
import gsf.fmum.util.Category;
import gsf.fmum.util.CategoryDomain;
import gsf.fmum.util.Quat4f;
...
@Mod(
	...
	guiFactory = "gsf.fmum.client.ConfigGuiFactory"
//	, clientSideOnly = true
)
public class FMUM
{
