...
import com.fmum.common.module.IModifyPredicate;
import com.fmum.common.module.IModifyState;
...
//			this.positionState = IModifyPredicate.OK; // FIXME: if this is needed?
	...
	protected class ModifyMode
	{
		...
		protected ModifyMode(
			...
			this.notifyMsg = "fmum.msg.modify_mode_" + name;
